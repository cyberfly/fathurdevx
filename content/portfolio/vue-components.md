...
sourceUrl: #
order: 14
challenge: "Internal projects suffered from inconsistent UI/UX because different teams were building similar components (buttons, modals, forms) from scratch each time."
solution: "Unified the company's design language by creating a shared library of reusable Vue + Laravel components, drastically reducing development time for new features."
---
